...
public sealed record MetricsInterval
{
    ...
    public MetricsInterval SmoothInterval(IntervalSmoothType smoothType)
    {
    ...
    public MetricsInterval SmoothIntervalEst(IntervalSmoothType smoothType)
    {
